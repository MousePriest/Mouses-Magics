...
import com.mouse.mousesmagics.spells.dew.MantleOfFlowersSpell;
...
public class SpellRegistries {
    ...
    public static final Supplier<AbstractSpell> MANTLE_SPELL =
            registerSpell(new MantleOfFlowersSpell());
