...
public class BloomBombRenderer extends EntityRenderer<BloomBomb> {
    ...
    public BloomBombRenderer(EntityRendererProvider.Context context) {
        super(context);
    ...
    @Override
    public void render(BloomBomb entity, float yaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferSource, int light) {
        poseStack.pushPose();
    ...
    @Override
    public ResourceLocation getTextureLocation(BloomBomb entity) {
        return TEXTURE;
    }

    private ResourceLocation getSwirlTextureLocation(BloomBomb entity) {
