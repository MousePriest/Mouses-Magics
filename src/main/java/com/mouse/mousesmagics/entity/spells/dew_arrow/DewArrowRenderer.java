...
public class DewArrowRenderer extends EntityRenderer<DewArrowProjectile> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(MousesMagics.MOD_ID,"textures/entity/dew_arrow.png");

    public DewArrowRenderer(Context context) {
        super(context);
    }

    @Override
    public void render(DewArrowProjectile entity, float yaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferSource, int light) {
        poseStack.pushPose();
    ...
    @Override
    public ResourceLocation getTextureLocation(DewArrowProjectile entity) {
